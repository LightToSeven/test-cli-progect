<template lang="html">
    <div class="contact">
        <div v-if="contact.checkbox">
            <div class="name-phone">
                <p><s>{{ contact.text }}</s></p>
            </div>
            <div class="checkbox" >
                <input type="checkbox" checked  @click='checkboxText'>
            </div>
        </div>
        <div v-else>
            <div class="name-phone">
            ...
            <div class="checkbox" >
                <input type="checkbox" @click='checkboxText'>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            checkboxText() {
                this.$emit('checkbox-text', this.contact)
            },
        }
